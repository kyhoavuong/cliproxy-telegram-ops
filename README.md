...
ghcr.io/kyhoavuong/cliproxy-telegram-ops-quota-gate:v0.2.2
ghcr.io/kyhoavuong/cliproxy-telegram-ops-alerts:v0.2.2
```
...
Stable release tags are published on GitHub and GHCR. See [v0.2.2](https://github.com/kyhoavuong/cliproxy-telegram-ops/releases/tag/v0.2.2).

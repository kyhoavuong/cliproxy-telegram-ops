...
ghcr.io/kyhoavuong/cliproxy-telegram-ops-quota-gate:v0.2.4
ghcr.io/kyhoavuong/cliproxy-telegram-ops-alerts:v0.2.4
```

The compose file also uses upstream images:

```text
eceasy/cli-proxy-api:v7.2.19
ghcr.io/willxup/cpa-usage-keeper:v1.11.1
cloudflare/cloudflared:latest
```

## Releases

Stable release tags are published on GitHub and GHCR. See [v0.2.4](https://github.com/kyhoavuong/cliproxy-telegram-ops/releases/tag/v0.2.4).
